...
<script type="text/javascript" src="../js/modifica_linea.js"></script>
<form id="lineForm">
	...
	<div class="form-group row">
		...
		<?php
			echo '<input type="number" class="form-control col-sm-12 col-md-2" id="qty" name="qty" min="1" value="' . 
			$_POST['qty'] .	'"/>';
		?>
	</div>
	<div class="form-group row">
		...
		<?php
			echo '<input type="number" class="form-control col-sm-12 col-md-1" id="discount" name="discount" min="0" max="100" value="' .
			$_POST['discount'] . '"/>';
		?>
	</div>
	<br>
